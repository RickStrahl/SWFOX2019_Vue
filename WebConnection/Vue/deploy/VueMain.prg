...
***            Vue.exe "config"
***            Vue.exe "config" "IIS://localhost/w3svc/21/root"
************************************************************************
...
IF VARTYPE(lcAction) = "C" AND StartsWith(LOWER(lcAction),"config")
         do Vue_ServerConfig.prg with lvParm1
      RETURN 
ENDIF

*** Load the server - wc3DemoServer class below
goWCServer = CREATE("VueServer")
...
IF llAutoRestart
   LiveReloadShutdown("DO VueMain.prg")
ELSE
...
**************************************************************
DEFINE CLASS VueServer AS WWC_SERVER OLEPUBLIC
*************************************************************
...
*** THIS.cAppIniFile = addbs(THIS.cAppStartPath) + "Vue.ini"
...
THIS.oConfig = CREATEOBJECT("VueConfig")
...
DO CASE
     ...
     CASE lcParameter == "VUEPROCESS"
         DO VueProcess with THIS
...
***************************************************************
DEFINE CLASS VueConfig AS wwServerConfig
***************************************************************
*: Author: Rick Strahl
...
THIS.oVueProcess = CREATEOBJECT("VueProcessConfig")
...
cHTMLPagePath = "C:\WebConnectionProjects\Vue\Web\"
cDATAPath = ".\"
cVirtualPath = "/Vue/"
...
*** Configuration class for the VueProcess Process class
DEFINE CLASS VueProcessConfig as wwConfig
