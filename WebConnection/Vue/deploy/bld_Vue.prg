...
EXE_FILE		  =		  	"Vue"
DCOM_ProgId       =			"Vue.VueServer"
DCOM_UserId		  =			"Interactive User"

*** Server Update Urls - fix these to point at your production Server/Virtual
HTTP_UPLOADURL    =         "http://localhost/Vue/UploadExe.wc"
HTTP_UPDATEURL 	  =         "http://localhost/Vue/UpdateExe.wc"

*** for ISAPI use this url
* HTTP_UPLOADURL    =         "http://localhost/Vue/wc.wc?wwmaint~FileUpload"
