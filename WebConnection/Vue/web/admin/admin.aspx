...
<div id="MainView">
    <div style="margin: 10px 20px;">
        ...
        <div class="alert alert-warning">
            <i class="fas fa-exclamation-triangle" style="font-size: 1.1em; color: firebrick;">
            </i>
                        ...
                        <li>
                            <form method="POST" action="wc.wc?wwmaint~CompileWCS">                    
                                ...
                                <label style="display:block">
                                    <input type="checkbox" name="chkRecursive" id="chkRecursive" checked="checked" class="with-font" />
                                    <label for="chkRecursive">Recurse sub-folders</label>
                                </label>
