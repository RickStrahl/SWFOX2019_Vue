...
function highlightJsBadge() {
    ...
    function addCodeHud() {
        ...
        var hudText = document.querySelector(templateId).outerHTML;
        ...
        for (var index = 0; index < $codes.length; index++) {
            ...
            $newHud = $newHud.firstChild;
            $newHud.style.display = "flex";            
            
            el.prepend($newHud,el.firstChild);                         
        }
        ...
        $content.addEventListener("click", 
                function(e) {
                    ...
                    if ($clicked.classList.value.indexOf("code-hud-copy-icon") > -1)
      ...
      function getTemplate() {
        var stringArray =         
            [
                ...
                "    }",
                "</style>",
                "<div id=\"CodeHudTemplate\" style=\"display:none\">",
                "    <div class=\"code-hud\">",
                "        <div class=\"code-hud-lang\" style=\"flex: 1\">{{lang}}</div>",
                "        <a href=\"#0\" title=\"Copy to clipboard\"><i class=\"fa fa-copy code-hud-copy-icon\"",
